...
Page({
  ...
  confirm: function(){
    if (this.data.correctAnswer >= 0){
      let ifNull = -1;  
      console.log(this.data.choiceContent[0] === null);
      for (var i = 0; i < this.data.choiceContent.length; i++) {
        if (this.data.choiceContent[i].length == 0 || this.data.choiceContent[i] === null) {
          ifNull = i;
          break;
        }
      }
